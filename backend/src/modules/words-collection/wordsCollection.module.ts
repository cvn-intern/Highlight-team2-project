...
@Module({
  imports: [TypeOrmModule.forFeature([WordsCollection, Word]), JwtModule, UserModule, WordModule, RedisModule],
  controllers: [WordsCollectionController],
  providers: [WordsCollectionService, Logger, WordsCollectionRepository, WordRepository, WordService],
