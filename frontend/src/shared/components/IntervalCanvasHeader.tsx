...
const IntervalCanvasHeader = ({ status = INTERVAL_INACTIVE }) => {
  ...
  switch (status) {
    case INTERVAL_SHOW_WORD:
      return (
        <>
          <p className="text-[3rem] text-sky-700 mt-5">{t("interval.intervalLabel")}</p>
        </>
      );
    case INTERVAL_NEW_TURN:
      return (
        <>
          <p className="text-[3rem] text-yellow-400 mt-5">{t("interval.newTurn")}</p>
    ...
    case INTERVAL_INACTIVE:
      return (
        <>
          <p className="text-[2rem] text-red-500 mt-5">{t("interval.inactive")}</p>
    ...
    case START_GAME:
      return (
        <>
          <p className="text-[3rem] text-yellow-400 mt-5">{t("interval.waiting")}</p>
        </>
      );
    case END_GAME:
      return (
        <>
          <p className="text-[3rem] text-yellow-400 mt-2">{t("interval.gameOver")}</p>
    ...
    default:
      return (
        <>
          <p className="text-[3rem] text-sky-700 mt-5">{t("interval.refreshRound")}</p>
        </>
      );
  }
};
