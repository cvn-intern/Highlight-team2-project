...
const ListOfRoom: React.FC<RoomFilterInformationProps> = ({ roomFilter }: RoomFilterInformationProps) => {
  return (
    <div className='bg-[#00416A]/40 pt-2 rounded-2xl w-full xl:w-[93.1%]'>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4  items-center justify-start gap-2 flex-1 pb-2 h-[540px] w-full pl-2 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-500 scrollbar-thumb-rounded-full">
        {roomFilter.map((roomFilter, index) => (
          <Card key={index} className="rounded-[10px] max-h-[255px] w-full aspect-square cursor-pointer hover:opacity-80 hover:bg-white">
            <CardContent className="flex flex-col justify-center items-center">
              ...
              <div className="flex flex-col items-center justify-center">
                <p className="flex flex-col justify-center items-center text-xl font-medium bg-gradient-to-r from-yellow-500 to-blue-500 bg-clip-text text-transparent">
                  ...
                  <p className='text-sm bg-gradient-to-r from-[#bdbaa3] to-[#b20a2c] bg-clip-text text-transparent'>
                ...
                <div className="flex flex-row items-center space-x-8 mt-6">
                  ...
                  <div className='flex flex-col justify-between items-center'>
                    ...
                    <div className="flex flex-col items-center justify-center">
                      <p className="font-medium text-2xl text-center bg-gradient-to-r from-yellow-500 to-blue-500 bg-clip-text text-transparent">
                        <strong>
                          {roomFilter.language.toUpperCase()}
                        </strong>
                      </p>
                    </div>
                  </div>
                  <div className='flex flex-col justify-between items-center'>
                    ...
                    <div className="flex flex-col items-center justify-center">
                      <p className="font-medium text-2xl text-center bg-gradient-to-r from-yellow-500 to-blue-500 bg-clip-text text-transparent">
                        <strong>
                          {roomFilter.current_round}/{roomFilter.number_of_round}
                        </strong>
                      </p>
                    </div>
                  </div>
