...
const CreateRooms = () => {
  return (
    <MainLayout>
      <div className="flex-col grid lg:w-[90%] mx-4">
        ...
        />
        <div className="justify-self-center w-[90%] lg:h-[90%] min-h-[70vh] bg-white flex flex-col items-center my-5 rounded-2xl p-8 lg:max-h-[90vh]">
          <CreateRoomsHeader />
          <CreateRoomsContent />
        </div>
      </div>
