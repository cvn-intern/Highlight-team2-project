...
export const Leaderboard: Array<{
    ...
    icon?: LucideIcon;
        ...
        },
        {
            ...
            score: 5750,
            img:
                "https://scontent.fsgn2-7.fna.fbcdn.net/v/t1.6435-9/108183626_2708185066093656_2321218826465342306_n.jpg?_nc_cat=100&cb=99be929b-59f725be&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=_EboMigy-BcAX-rEj2Z&_nc_ht=scontent.fsgn2-7.fna&oh=00_AfCBMlb8Dkczt-eYbM2LwuiFI0oc4B8hjjKFomQwILkplg&oe=64D73034",
            host: false,
        }
    ];